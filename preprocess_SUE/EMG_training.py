...
def evaluateClassifier(argv):
    ...
    model,flops =Classify(clf,featuresAll,bestParam)
    ...
    return clf,model,labelsAll,MEAN,STD,bestParam,flops
...
def Classify(clf,featuresAll, bestParam):
    if clf == 'svm':
        model,flops = Classification.trainSVM(featuresAll, bestParam)
    elif clf == 'svm_rbf':
        model,flops = Classification.trainSVM_RBF(featuresAll, bestParam)
    elif clf == 'extratrees':
        model,flops = Classification.trainExtraTrees(featuresAll, bestParam)
    elif clf == 'randomforest':
        model,flops = Classification.trainRandomForest(featuresAll, bestParam)
    elif clf == 'knn':
        model,flops = Classification.trainKNN(featuresAll, bestParam)
    elif clf == 'gradientboosting':
        model,flops = Classification.trainGradientBoosting(featuresAll, bestParam)
