...
def SingleUserEvaluation(dirName,classifier,c_param):
    ...
    for uid,user in enumerate(user_ids):
        ...
        for file_test in user_files:
            ...
            CM_user, CM_user_post, CM_user_post_2,predictions, post_predictions ,post_predictions_2,flops = GroupClassification([train_data_NF, train_data_F], [test_data_NF, test_data_F], classifier, c_param,test_ids,dirName)
            CM += CM_user
...
def GroupClassification(train,test,classifier,param,test_ids,eval_source):
    ...
    model,flops = Classify(classifier, features_norm, param)
    # TEST
    ...
    return CM,CM_post,CM_post_2,predictions,post_predictions,post_predictions_2,flops
...
if __name__ == '__main__':
    ...
    SingleUserEvaluation("../data/Study1_medfilt11_EMG",'svm',50)
